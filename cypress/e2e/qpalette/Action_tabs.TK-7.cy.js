      it('Tabs', () => {
        ...
        cy.get(':nth-child(2) > :nth-child(2) > .p-element > .p-radiobutton > .p-radiobutton-box').click()
        cy.reload()
        cy.get('.active > .q-tabs__link > .q-tabs__link-text').should('contain','Конвертер Figma')
    })